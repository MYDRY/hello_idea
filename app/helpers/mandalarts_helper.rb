  ...
  def show_sub_elem(subNum)
    content_tag(:div, id: subNum, style: 'visibility: hidden;') do
      ...
      (1..9).each do |n|
        ...
        concat content_tag(:input, '', {value: "@simple_mandal.elem_#{subNum}_#{n}", name: "elem_#{subNum}_#{n}" }.merge(attributes))
      end
    end
  end
  ...
  def show_core_elem
    content_tag(:div, id: 'core') do
      ...
      (1..9).each do |n|
        ...
        concat content_tag(:input, '', {value: "@simple_mandal.elem_5_#{n}", name: "elem_5_#{n}"}.merge(attributes))
      end
    end
  end
end
